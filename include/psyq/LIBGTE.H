 ...
 *
 *$Id: libgte.h,v 1.24 1996/03/21 06:43:03 kaol Exp $
 */
...
extern u_long *GsTMDfastTG3L_FLIP(TMD_P_TG3 *primtop,SVECTOR *vertop,SVECTOR *nortop,
		POLY_GT3 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTG3LFG_FLIP(TMD_P_TG3 *primtop,SVECTOR *vertop,
		SVECTOR *nortop,POLY_GT3 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTG3NL_FLIP(TMD_P_TG3 *primtop,SVECTOR *vertop,
		SVECTOR *nortop,POLY_GT3 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTNG3_FLIP(TMD_P_TNG3 *primtop,SVECTOR *vertop,
		POLY_GT3 *s,u_long n,u_long shift,GsOT *otp);
