...
extern  "C" {
	...
	void	gte_apply_matrixll(MATRIX *m, VECTOR *vi, VECTOR *vo);
	void	gte_copy_matrix(MATRIX *m0, MATRIX *m1);
	void	gte_init();
	...
	void	GsSortClear(u_char r, u_char g, u_char b, GsOT *ot);
	void	GsSortObject4J(GsDOBJ2 *objp, GsOT *otp, int shift, u_long *scratch);
	void	Gssub_make_matrix(MATRIX *mp, short int s, short int c, char rotate);
